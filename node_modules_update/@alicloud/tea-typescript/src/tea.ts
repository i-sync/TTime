/* eslint-disable @typescript-eslint/explicit-function-return-type, no-useless-escape, no-empty, prettier/prettier, prefer-const */
...
export async function doAction(request: Request, runtime: TeaObject = null): Promise<Response> {
    ...
    if (runtime) {
        ...
        if (request.protocol && request.protocol.toLowerCase() === 'https') {
          if(typeof runtime.httpsProxy !== 'undefined') {
            options.agent = runtime.httpsProxy;
          }
        } else {
          if(typeof runtime.httpProxy !== 'undefined') {
            options.agent = runtime.httpProxy;
          }
        }
